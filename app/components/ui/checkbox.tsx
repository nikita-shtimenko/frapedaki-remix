...
export function CheckboxGroup({
  ...
  return (
    <div
      ...
      dir="rtl" // Add this attribute to enforce RTL layout
    />
  );
}
  ...
  return (
    <Headless.Field
      ...
      className={clsx(
        ...
        // Add RTL support
        "rtl:grid-cols-[1fr_1.125rem] rtl:sm:grid-cols-[1fr_1rem] rtl:[&>[data-slot=control]]:col-start-2 rtl:[&>[data-slot=description]]:col-start-1 rtl:[&>[data-slot=label]]:col-start-1",
      )}
      dir="rtl" // Add this attribute to enforce RTL layout
    />
  );
