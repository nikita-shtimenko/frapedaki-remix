  ...
  return (
    ...
    >
      <Headless.Textarea
        ...
        className={clsx([
          // Basic layout
          "relative block h-full w-full appearance-none rounded-lg py-[calc(theme(spacing[2.5])-1px)] sm:py-[calc(theme(spacing[1.5])-1px)]",
          // Padding adjusted for RTL
          "pl-[calc(theme(spacing.3)-1px)] pr-[calc(theme(spacing[3.5])-1px)] sm:pl-[calc(theme(spacing[1.5])-1px)] sm:pr-[calc(theme(spacing.3)-1px)]",
          // Typography
