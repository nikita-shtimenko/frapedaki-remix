    ...
    >
      <div className="flow-root">
        ...
        >
          ...
          >
            <table className="min-w-full text-right text-sm/6">
              {children}
            </table>
          </div>
        </div>
...
export function TableHeader({
  ...
  return (
    <th
      ...
      className={clsx(
        className,
        "border-b border-b-zinc-950/10 px-4 py-2 font-medium first:pr-[var(--gutter,theme(spacing.2))] last:pl-[var(--gutter,theme(spacing.2))] dark:border-b-white/10",
        grid &&
          "border-r border-r-zinc-950/5 last:border-r-0 dark:border-r-white/5",
...
export function TableCell({
  ...
  return (
    <td
      ...
      className={clsx(
        className,
        "relative px-4 first:pr-[var(--gutter,theme(spacing.2))] last:pl-[var(--gutter,theme(spacing.2))]",
