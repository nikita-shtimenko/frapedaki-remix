...
export function NavbarSpacer({
  ...
  return (
    <div
      aria-hidden="true"
      {...props}
      className={clsx(className, "-mr-4 flex-1")}
    />
  );
}
...
export const NavbarItem = React.forwardRef(function NavbarItem(
  ...
  let classes = clsx(
    ...
    "data-[slot=icon]:last:[&:not(:nth-child(2))]:*:mr-auto data-[slot=icon]:last:[&:not(:nth-child(2))]:*:size-5 sm:data-[slot=icon]:last:[&:not(:nth-child(2))]:*:size-4",
    // Avatar
