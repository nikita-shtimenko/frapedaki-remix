...
export function DropdownItem({
  ...
  let classes = clsx(
    ...
    // Icons
    "[&>[data-slot=icon]]:col-start-1 [&>[data-slot=icon]]:row-start-1 [&>[data-slot=icon]]:mr-0.5 [&>[data-slot=icon]]:ml-2.5 [&>[data-slot=icon]]:size-5 sm:[&>[data-slot=icon]]:ml-2 [&>[data-slot=icon]]:sm:size-4",
...
export function DropdownHeader({
  ...
  return (
    <div
      ...
      className={clsx(
        className,
        "col-span-5 px-3.5 pb-1 pt-2.5 text-right sm:px-3",
      )}
    />
  );
}
...
export function DropdownHeading({
  ...
  return (
    <Headless.MenuHeading
      ...
      className={clsx(
        className,
        "col-span-full grid grid-cols-[auto,1fr] gap-x-12 px-3.5 pb-1 pt-2 text-right text-sm/5 font-medium text-zinc-500 dark:text-zinc-400 sm:px-3 sm:text-xs/5",
      )}
    />
  );
}
...
export function DropdownLabel({
  ...
  return (
    <Headless.Label
      {...props}
      data-slot="label"
      className={clsx(className, "col-start-2 row-start-1 text-right")}
      {...props}
    />
  );
}
...
export function DropdownDescription({
  ...
  return (
    <Headless.Description
      ...
      className={clsx(
        className,
        "col-span-2 col-start-2 row-start-2 text-right text-sm/5 text-zinc-500 group-data-[focus]:text-white dark:text-zinc-400 sm:text-xs/5 forced-colors:group-data-[focus]:text-[HighlightText]",
      )}
    />
  );
}
...
>) {
  return (
    <Headless.Description
      ...
      className={clsx(
        className,
        "col-start-5 row-start-1 flex justify-self-start",
      )}
    >
